...
NCAAF_ALIASES: dict[str, str] = {
    ...
    "ETAM": "EAST TEXAS A AND M",
    "ETAMU": "EAST TEXAS A AND M",
    "EAST TEXAS A AND M": "EAST TEXAS A AND M",
    "EAST TEXAS A&M": "EAST TEXAS A AND M",
    "ARMY": "ARMY",
    "NAVY": "NAVY",
    "AF": "AIR FORCE",
    "AIR FORCE": "AIR FORCE",
    ...
    # ESPN abbreviations → stage-card / Odds API long names (ledger settlement)
    "BCU": "BETHUNE COOKMAN",
    "WES": "WEST GEORGIA",
    ...
    "TOW": "TOWSON",
    "TOWSON": "TOWSON",
    # ESPN scoreboard abbreviations (ledger settlement)
